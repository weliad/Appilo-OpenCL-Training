...
int main(int argc, char **argv)
{
    ...
    // TODO Update the upper_case kernel in the OpenCL C code, to a data-parallel implementation.
	const char *srccode =  
		"__kernel                                                       "
	...
	// TODO update the work-group size definition to spawn an appropriate ND-Range kernel.
    size_t gws[1] = { 1 };
	size_t lws[1] = { 1 };
